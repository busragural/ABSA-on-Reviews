...
def analyze_sentiment_roberta(text):
    """CardiffNLP XLM-RoBERTa modeliyle sentiment analizi yapar."""
    ...
    for sentence in doc.sents:  # Cümlelere ayır
        ...
        for aspect, keywords in aspects.items():
            if any(keyword.lower() in sentence_text_lower for keyword in keywords):
                sentiment, score = analyze_sentiment_roberta(sentence.text)  # Sentiment analizi yap
...
output_file = "./Data/output/XLM-Roberta_ABSA.csv"
