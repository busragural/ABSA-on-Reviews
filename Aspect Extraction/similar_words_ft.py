...
def update_frequencies_with_similar_words(frequency_file, model_fasttext, similarity_threshold=0.7, output_file="./Data/output/updated_frequency_words_ft.csv"):
    word_frequency_df = pd.read_csv(frequency_file)
    
    top_words = word_frequency_df.head(500)
    
    top_words['Updated_Frequency_ft'] = top_words['Frequency']
    top_words['Similar_Words_ft'] = ""  
    ...
    for index, row in top_words.iterrows():
        ...
        for similar_word, _ in  similar_words_ft:
        ...
        top_words.at[index, 'Updated_Frequency_ft'] = main_frequency + similar_frequencies
        top_words.at[index, 'Similar_Words_ft'] = ", ".join(similar_words) if similar_words else "None"
...
if __name__ == "__main__":
    ...
    update_frequencies_with_similar_words("./Data/output/frequency_all_words.csv", model_fasttext)
